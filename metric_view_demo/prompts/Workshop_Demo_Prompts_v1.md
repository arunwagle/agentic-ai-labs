...
1. Always execute the task with a clean context. Before running any tasks,
  - Delete the /Workspace/Users/<your-username>/Workshop_Demo/ folder recursively using "dbutils.fs.rm" API .
  - Delete the schema aibi_metrics_view_demo_v1. If not present, ignore errors.
2. Create /Workspace/Users/<your-username>/Workshop_Demo/ folder.
...
1. Create a schema "aibi_metrics_view_demo_v1" under catalog "catalog_7w4dm4_eq04qz".
...
4. Move the file to /Workspace/Users/<your-username>/Workshop_Demo/

### 2: Create sample Dashboards
1. Create Dashboards
  -  Create "Workshop Metrics View Orders Dashboard V1" using all the "Metric View Sample Queries V1" Queries. 
  - Create a second Dashboard "Workshop Metrics View Orders & Joins Dashboard V1" that specifically illustrates and visualizes metrics and dimensions involving joins to related dimension tables (e.g., customer or lineitem). Include queries that demonstrate the impact and value of these joins.
2. For each widget:
...
4. Move the Dashboard to /Workspace/Users/<your-username>/Workshop_Demo/

### 3: Create Genie Space
1. Create or update a Genie space "Workshop Metrics View Space V1" using MetricView "orders_metric_view". 
...
4. Move the Genie Space to /Workspace/Users/<your-username>/Workshop_Demo/
...
3. Move the readme.md to /Workspace/Users/<your-username>/Workshop_Demo/